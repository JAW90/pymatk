...
from pymatk.abstract_classes import ControllerBase
from pymatk.instruments import Instrument, InstrumentRack
...
class TestController(ControllerBase):
    ...
    def update(self, subject: Instrument) -> None:
        self.observed_value = subject.get_variable_value(self._observed_variable)
        if self._running:
            self.update_output()
